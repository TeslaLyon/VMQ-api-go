...
type QrcodeRepository interface {
	...
	GetQrcodeByPriceAndType(price int64, qrcodeType int) (*model.PayQrcode, error) // 新增方法
	UpdateStatus(qrcodeID uint, state int) error
	ExistsByUserAndPrice(userID uint, price int64, qrcodeType int) (bool, error)
}
...
func (r *qrcodeRepository) ExistsByUserAndPrice(userID uint, price int64, qrcodeType int) (bool, error) {
	var count int64
...
func (r *qrcodeRepository) GetQrcodeByPriceAndType(price int64, qrcodeType int) (*model.PayQrcode, error) {
	var qrcode model.PayQrcode
